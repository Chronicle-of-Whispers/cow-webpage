...
New documentation pages are added as Markdown under `src/content/docs/docs/` (German) and `src/content/docs/en/docs/` (English), then registered in the sidebar in `astro.config.mjs`.
